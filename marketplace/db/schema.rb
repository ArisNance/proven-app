...
ActiveRecord::Schema[7.1].define(version: 2026_05_01_101500) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buyer_id", "maker_id"], name: "index_conversations_on_buyer_id_and_maker_id", unique: true
    t.index ["buyer_id"], name: "index_conversations_on_buyer_id"
    t.index ["maker_id"], name: "index_conversations_on_maker_id"
  end

  create_table "flagged_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_flagged_items_on_product_id"
  end
  ...
  create_table "listing_fee_subscriptions", force: :cascade do |t|
    t.bigint "shop_id", null: false
    t.string "stripe_subscription_id", null: false
    t.integer "status", default: 0, null: false
    t.integer "quantity", default: 1, null: false
    t.integer "unit_amount_cents", default: 15, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shop_id"], name: "index_listing_fee_subscriptions_on_shop_id"
  ...
  create_table "maker_applications", force: :cascade do |t|
    ...
    t.jsonb "communication_history", default: [], null: false
    ...
    t.index ["workflow_status"], name: "index_maker_applications_on_workflow_status"
  end
  ...
  create_table "product_approvals", force: :cascade do |t|
    ...
    t.bigint "reviewer_id"
    t.integer "state", default: 0, null: false
    t.string "moderation_decision", default: "pending", null: false
    t.float "duplicate_score", default: 0.0, null: false
    t.jsonb "policy_flags", default: [], null: false
    t.datetime "reviewed_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "recommendation_caches", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["buyer_id"], name: "index_recommendation_caches_on_buyer_id"
    t.index ["expires_at"], name: "index_recommendation_caches_on_expires_at"
  end

  create_table "shop_approvals", force: :cascade do |t|
    t.bigint "shop_id", null: false
    t.bigint "reviewer_id"
    t.integer "state", default: 0, null: false
    t.datetime "reviewed_at"
  ...
  create_table "shops", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "username"
    t.index ["maker_id"], name: "index_shops_on_maker_id", unique: true
