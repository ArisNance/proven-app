module Makers
  class ShopsController < ApplicationController
    ...
    before_action :ensure_maker_profile!, only: %i[new create]
    ...
    def ensure_maker_profile!
      return if current_user.maker_profile.present?

      redirect_to makers_onboarding_path, alert: "Complete maker onboarding before creating a shop."
    end
